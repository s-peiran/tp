...
public class JsonAdaptedMeetingTest {
    ...
    public void toModelType_invalidTitle_throwsIllegalValueException() {
        JsonAdaptedMeeting meeting =
                new JsonAdaptedMeeting(INVALID_TITLE, VALID_TIME, VALID_PLACE, VALID_DESCRIPTION);
    ...
    public void toModelType_invalidTime_throwsIllegalValueException() {
        JsonAdaptedMeeting meeting =
                new JsonAdaptedMeeting(VALID_TITLE, INVALID_TIME, VALID_PLACE, VALID_DESCRIPTION);
    ...
    public void toModelType_nullTime_throwsIllegalValueException() {
        JsonAdaptedMeeting meeting =
                new JsonAdaptedMeeting(VALID_TITLE, null, VALID_PLACE, VALID_DESCRIPTION);
    ...
    public void toModelType_invalidPlace_throwsIllegalValueException() {
        JsonAdaptedMeeting meeting =
                new JsonAdaptedMeeting(VALID_TITLE, VALID_TIME, INVALID_PLACE, VALID_DESCRIPTION);
    ...
    public void toModelType_nullPlace_throwsIllegalValueException() {
        JsonAdaptedMeeting meeting =
                new JsonAdaptedMeeting(VALID_TITLE, VALID_TIME, null, VALID_DESCRIPTION);
    ...
    public void toModelType_nullDescription_throwsIllegalValueException() {
        JsonAdaptedMeeting meeting =
                new JsonAdaptedMeeting(VALID_TITLE, VALID_TIME, VALID_PLACE, null);
