...
public class EditContactCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, " 1" + INVALID_NAME_DESC
                + INVALID_EMAIL_DESC + VALID_PHONE_AMY, Name.MESSAGE_CONSTRAINTS);
    }
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = " " + targetIndex.getOneBased() + PHONE_DESC_BOB
                + TAG_DESC_HUSBAND + EMAIL_DESC_AMY + NAME_DESC_AMY + TAG_DESC_FRIEND;
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = " " + targetIndex.getOneBased() + PHONE_DESC_AMY
                + EMAIL_DESC_AMY + TAG_DESC_FRIEND + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + TAG_DESC_FRIEND + PHONE_DESC_BOB + EMAIL_DESC_BOB + TAG_DESC_HUSBAND;
        ...
        userInput = " " + targetIndex.getOneBased() + INVALID_PHONE_DESC
                + INVALID_EMAIL_DESC + INVALID_PHONE_DESC + INVALID_EMAIL_DESC;
