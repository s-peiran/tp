...
AddressBook stores data by serializing `JsonAdaptedContact` into `json` with the help of an external library — Jackson. Let’s update `JsonAdaptedContact` to work with our new `Contact`!
